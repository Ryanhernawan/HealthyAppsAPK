...
import { getDatabase, ref, onValue, get, set, push, orderByChild } from "firebase/database";
...
const ForumPage = ({ value, setValue, placeholder, item }) => {
  ...
  useEffect(() => {
    ...
    // const orderedDbRef = orderByChild(dbRef, "timestamp");
    ...
    onValue(dbRef, (snapshot) => {
      ...
      if(data){
        ...
        newPost.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
        // console.log(newPost);
